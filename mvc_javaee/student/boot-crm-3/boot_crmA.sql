/*
 ...
 Source Server         : mybatis_2
 Source Server Type    : MySQL
 Source Server Version : 50527
 Source Host           : localhost:3306
 Source Schema         : boot_crma

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 30/06/2020 17:00:42
*/
...
INSERT INTO `base_dict` VALUES ('35', '010', '商业公司', '外国', NULL, 2, '1', NULL);
INSERT INTO `base_dict` VALUES ('36', '010', '商业公司', '中国', NULL, 1, '1', NULL);
...
CREATE TABLE `system`  (
  ...
  `syst_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统名字',
  `syst_user_id` int(11) DEFAULT NULL COMMENT '系统对应分管id',
  `syst_create_id` int(11) DEFAULT NULL COMMENT '系统新建的id',
  `syst_source` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统对应商业公司个体选项id',
  `syst_industry` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统对应系统行业个体选项id',
  `syst_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统对应系统等级个体选项id',
  `syst_linkman` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统对应联系人名字',
  `syst_phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统号',
  `syst_mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统编号',
  `syst_zipcode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统码',
  `syst_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统地址',
  `syst_createtime` datetime DEFAULT NULL COMMENT '系统生成时间',
...
INSERT INTO `system` VALUES (178, 'win7', 0, 0, '35', '39', '40', 'daming', '10010', '10087', '530000', '530000', '2020-06-27 20:43:37');
INSERT INTO `system` VALUES (179, 'win10', 0, 0, '35', '39', '40', 'qiumo', '10001', '10089', '530001', '530001', '2020-06-27 20:49:01');
INSERT INTO `system` VALUES (180, 'win xp', 0, 6, '36', '39', '41', '110', '110', '100', '100000', '100000', '2020-06-27 20:55:50');
